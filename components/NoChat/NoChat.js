...
import noChatImage from "../../public/noChatImage.png"
	...
	return(
		...
		<div style={{
			...
			<div style={{width:220,height:280,position:"relative"}}>
				<Image style={{objectFit:"cover"}} fill src={noChatImage}/>	
			</div>
